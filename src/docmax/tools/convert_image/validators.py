"""Checks run against the staged output of ``convert-image``, before it replaces anything.
...
def is_readable_image(expected_format: str) -> Validator:
    ...
    on the output format specified by the destination extension.
    """
    ...
    def validate(produced: Path) -> None:
        ...
        try:
            ...
            raise OutputValidationError(
                f"The output of 'convert-image' could not be reopened as an image: {exc}",
