"""Checks run against the staged output of ``compress-image``, before it replaces anything.
...
def is_readable_image(expected_format: str) -> Validator:
    ...
    on the input format, which compress-image preserves.
    """
    ...
    def validate(produced: Path) -> None:
        ...
        try:
            ...
            raise OutputValidationError(
                f"The output of 'compress-image' could not be reopened as an image: {exc}",
